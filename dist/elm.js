...
var _rune_b$xwing_cards$XWingData$pilotDecoder = A5(
	_elm_lang$core$Json_Decode$object4,
	_rune_b$xwing_cards$XWingData$PilotCard,
	...
	A2(_elm_lang$core$Json_Decode_ops[':='], 'ship', _elm_lang$core$Json_Decode$string));
...
var _rune_b$xwing_cards$XWingData$ugradeDecoder = A5(
	_elm_lang$core$Json_Decode$object4,
	_rune_b$xwing_cards$XWingData$UpgradeCard,
	A2(_elm_lang$core$Json_Decode_ops[':='], 'name', _elm_lang$core$Json_Decode$string),
	_elm_lang$core$Json_Decode$oneOf(
		_elm_lang$core$Native_List.fromArray(
			[
...
var _rune_b$xwing_cards$XWingData$Pilot = function (a) {
	return {ctor: 'Pilot', _0: a};
};
var _rune_b$xwing_cards$XWingData$getCards = function () {
	var upgradesTask = A2(
		_elm_lang$core$Task$map,
		function (pilots) {
			return A2(_elm_lang$core$List$map, _rune_b$xwing_cards$XWingData$Upgrade, pilots);
		},
		_rune_b$xwing_cards$XWingData$getUpgrades);
	var pilotsTask = A2(
		_elm_lang$core$Task$map,
		function (pilots) {
			return A2(_elm_lang$core$List$map, _rune_b$xwing_cards$XWingData$Pilot, pilots);
		},
		_rune_b$xwing_cards$XWingData$getPilots);
	return A2(
		_elm_lang$core$Task$map,
		function (tasks) {
	...
	function (text, card) {
		...
		if (_p3.ctor === 'Pilot') {
			...
			return A2(
				...
				_elm_lang$core$String$toLower(_p4.name)) || A2(
				_elm_lang$core$String$contains,
				_elm_lang$core$String$toLower(text),
				_elm_lang$core$String$toLower(_p4.text));
		} else {
			var _p5 = _p3._0;
			return A2(
				_elm_lang$core$String$contains,
				_elm_lang$core$String$toLower(text),
				_elm_lang$core$String$toLower(_p5.name)) || A2(
				_elm_lang$core$String$contains,
				_elm_lang$core$String$toLower(text),
				_elm_lang$core$String$toLower(_p5.text));
		}
	});
var _rune_b$xwing_cards$Main$Model = F3(
	function (a, b, c) {
		return {searchString: a, cards: b, searchResults: c};
	});
var _rune_b$xwing_cards$Main$Found = function (a) {
	return {ctor: 'Found', _0: a};
};
var _rune_b$xwing_cards$Main$searchCards = F2(
	function (text, cards) {
		var found = A2(
			_elm_lang$core$List$filter,
			_rune_b$xwing_cards$Main$matchCard(text),
			cards);
		return A3(
			...
			_elm_lang$core$Task$succeed(
				_rune_b$xwing_cards$Main$Found(found)));
	});
var _rune_b$xwing_cards$Main$update = F2(
	function (msg, model) {
		var _p6 = msg;
		switch (_p6.ctor) {
			case 'NoOp':
			...
			case 'Search':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{searchString: _p7}),
					_1: A2(_rune_b$xwing_cards$Main$searchCards, _p7, model.cards)
				};
			case 'Found':
				return {
					ctor: '_Tuple2',
			...
			default:
				var x = A2(_elm_lang$core$Debug$log, 'GetCardsFailed', _p6._0);
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
		}
	});
var _rune_b$xwing_cards$Main$GetCardsFailed = function (a) {
	return {ctor: 'GetCardsFailed', _0: a};
};
var _rune_b$xwing_cards$Main$GetCardsSuccess = function (a) {
	return {ctor: 'GetCardsSuccess', _0: a};
};
var _rune_b$xwing_cards$Main$getCardsCmd = A3(_elm_lang$core$Task$perform, _rune_b$xwing_cards$Main$GetCardsFailed, _rune_b$xwing_cards$Main$GetCardsSuccess, _rune_b$xwing_cards$XWingData$getCards);
var _rune_b$xwing_cards$Main$init = {
	ctor: '_Tuple2',
	_0: A3(
		_rune_b$xwing_cards$Main$Model,
		'',
		_elm_lang$core$Native_List.fromArray(
			[]),
		_elm_lang$core$Native_List.fromArray(
			[])),
	_1: _rune_b$xwing_cards$Main$getCardsCmd
};
var _rune_b$xwing_cards$Main$Search = function (a) {
	return {ctor: 'Search', _0: a};
};
var _rune_b$xwing_cards$Main$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$value(model.searchString),
								_elm_lang$html$Html_Events$onInput(_rune_b$xwing_cards$Main$Search),
				...
				A2(_elm_lang$core$List$map, _rune_b$xwing_cards$Main$viewCard, model.searchResults))
			]));
};
var _rune_b$xwing_cards$Main$main = {
	main: _elm_lang$html$Html_App$program(
		{init: _rune_b$xwing_cards$Main$init, view: _rune_b$xwing_cards$Main$view, update: _rune_b$xwing_cards$Main$update, subscriptions: _rune_b$xwing_cards$Main$subscriptions})
};
var _rune_b$xwing_cards$Main$NoOp = {ctor: 'NoOp'};

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _rune_b$xwing_cards$Main$main === 'undefined' ? null : _rune_b$xwing_cards$Main$main);
